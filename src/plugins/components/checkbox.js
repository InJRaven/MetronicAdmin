...
export default plugin(({ addComponents, theme }) => {
  addComponents({
    ...
    '.checkbox-sm[type="checkbox"]': {
      borderRadius: theme("custom.components.checkbox.sm.borderRadius"),
    ...
    '.checkbox-lg[type="checkbox"]': {
      borderRadius: theme("custom.components.checkbox.lg.borderRadius"),
